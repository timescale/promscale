...
EXPECTED_OUTPUT1='{"status":"success","data":["__name__","code","custom_label","grpc_code","grpc_method","grpc_service","grpc_type","handler","instance","job","kind","le","method","mode","name","namespace","node","path","pool","quantile","status","subsystem","type","version"]}'
