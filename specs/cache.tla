...
define
    TypeInvariant == 
        ...
        /\ cached_series \in SUBSET SeriesId
    ...
    ReceiveInput:
        either
            ...
            CacheLookup:
                ...
                new_series := new_series \ cached_series;
            \* CacheUpdate:
            \*     cached_series := cached_series \union new_series;
            IngestTransaction:
...
\* BEGIN TRANSLATION (chksum(pcal) = "8958fda3" /\ chksum(tla) = "c033b308")
...
CacheLookup(self) == /\ pc[self] = "CacheLookup"
                     ...
                     /\ new_series' = [new_series EXCEPT ![self] = new_series[self] \ cached_series]
