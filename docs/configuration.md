...
| metrics.promql.default-caggs-column                 |             string             |    avg    | Default column to consider while querying CAgg metrics in absence of `__column__` label in PromQL query.                                                                                                                                                                                                                               |
| metrics.promql.default-caggs-schema                 |             string             |  public   | Default schema to consider while querying CAgg metrics in absence of `__schema__` label in PromQL query.                                                                                                                                                                                                                               |
