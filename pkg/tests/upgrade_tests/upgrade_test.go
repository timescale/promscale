...
func TestMain(m *testing.M) {
	...
	baseExtensionState.SetTimescaleDockerImage("ghcr.io/timescale/dev_promscale_extension:jg-ha-dockerfile-ts2-pg14")
...
func startDB(t *testing.T, ctx context.Context) (*pgx.Conn, testcontainers.Container, io.Closer) {
	...
	// TODO (james): Replace hardcoded value
	extensionState := testhelpers.NewTestOptions(testhelpers.Timescale, "ghcr.io/timescale/dev_promscale_extension:jg-ha-dockerfile-ts2-pg14")
